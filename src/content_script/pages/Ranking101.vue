...
#chordwiki-plus-ranking-page
  ...
  .container
    .section
      ...
      .level
        .level-left
          b-button(type="is-info", tag="router-link", :to="{name: 'ranking'}", icon-left="chevron-left") 前のページ
        .level-right
          b-button(type="is-info", tag="router-link", :to="{name: 'ranking201'}", icon-right="chevron-right") 次のページ
